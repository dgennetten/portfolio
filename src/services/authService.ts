...
export const AUTH_TOKEN_KEY    = 'kdg_auth_token';
export const AUTH_SESSION_KEY  = 'kdg_auth';
export const AUTH_EXPIRES_KEY  = 'kdg_auth_expires';
export const AUTH_REMEMBER_KEY = 'kdg_auth_remember';
